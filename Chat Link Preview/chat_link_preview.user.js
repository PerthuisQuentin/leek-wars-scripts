...
(function()
{
	...
	var handler = {
		'pastebin': function(data) {
			...
			var languageReg = new RegExp('<div class="paste_box_line2".*syntax:.?<[^>]*>([^<]*)');
	...
	function check() {
		...
		links.each(function() {
			...
			$(cont).css({
				'border-left': 'solid 7px hsla(0, 0%, 0%, 0.2)',
